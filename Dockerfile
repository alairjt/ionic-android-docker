...
RUN apt-get update && apt-get install -y git  lib32ncurses5 lib32gomp1 lib32z1-dev lib32bz2-dev lib32stdc++6 lib32z1 npm nodejs nodejs-legacy s3cmd build-essential curl openjdk-8-jdk-headless sendemail libio-socket-ssl-perl libnet-ssleay-perl && apt-get clean && rm -rf /var/lib/apt/lists/*
